        ...
        <main className="overflow-x-hidden bg-white">
            ...
            >
                ...
                <div className="absolute inset-0 bg-[#012060]/10 flex items-center justify-center">
                    <h1 className="text-4xl sm:text-6xl md:text-7xl lg:text-8xl font-black text-white text-center tracking-tighter drop-shadow-2xl" data-aos="fade-down">
            ...
            <section className="container mx-auto px-5 md:px-8 py-8 md:py-20">
                <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12">
                    <div className="md:w-1/2">
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6" data-aos="fade-right">
                            <span className="text-[#012060]">{cmsData['content-heading-black'] || 'Educating Minds,'}</span>
                            <br />
                            <span style={{ color: accentColor }} className="lg:text-5xl font-bold">{cmsData['content-heading-orange'] || 'Empowering Futures'}</span>
                        </h2>

                        <p className="text-gray-800 text-lg md:text-xl font-medium leading-relaxed mb-6" data-aos="fade-right">
                    ...
                    <div className="md:w-1/2 relative flex justify-center" data-aos="zoom-in">
                        <div className="relative z-5 w-full h-[350px] md:h-[500px] flex justify-center rounded-4xl overflow-hidden shadow-2xl">
                            <img
            ...
            {/* ===== WHAT WE PROVIDE ===== */}
            <section className="relative mx-4 md:mx-0 overflow-hidden bg-idara-yellow py-12 md:py-16 px-6 md:px-12" data-aos="fade-up">
                <div className="container mx-auto max-w-5xl">
                    ...
                    <p className="text-white text-center text-lg md:text-xl font-bold mb-10 max-w-3xl mx-auto">
                        {cmsData['services-list'] || 'Quality education · Trained faculty · Safe learning environments · Affordable or free schooling.'}
                    </p>

                    <div className="grid grid-cols-1 md:grid-cols-2 gap-x-16 gap-y-4 mb-12 max-w-2xl mx-auto">
                        {[
                            ...
                            <div key={i} className="flex items-center gap-3">
                                ...
                                <span className="text-[#012060] font-black text-lg">{item}</span>
                            </div>
                        ))}
                    </div>
            ...
            <section className="relative mt-px w-full overflow-hidden h-55 md:h-80 leading-0" data-aos="fade-up">
                <img
