        ...
        <main className="overflow-x-hidden bg-white font-montserrat">
            ...
            <section className="relative mt-0 md:mt-20 w-full h-[40vh] md:h-[70vh] overflow-hidden" data-aos="fade">
                ...
                <div className="absolute inset-0 flex items-center justify-center z-20">
                    <h1 className="text-3xl sm:text-4xl md:text-8xl font-black text-white tracking-tighter text-center px-4 drop-shadow-2xl">
            ...
            <section className="relative w-full py-10 md:py-16 bg-white">
                <div className="container mx-auto px-4 sm:px-6 md:px-12 lg:px-32">

                    {/* Header Intro */}
                    <div className="mb-10 md:mb-14" data-aos="fade-up">
                        <h2 className="text-2xl sm:text-3xl md:text-5xl font-bold text-[#012060] mb-4 md:mb-6 tracking-tight">
                    ...
                    {/* About Project */}
                    <div className="mb-10 md:mb-14" data-aos="fade-up">
                        <h3 className="text-xl sm:text-2xl md:text-4xl font-bold text-[#012060] mb-3 md:mb-4 tracking-tight">
                            About the Project
                        </h3>
                    ...
                    <div className="mb-12 md:mb-16" data-aos="fade-up">
                        ...
                        <p className="text-gray-700 text-base sm:text-lg md:text-xl leading-relaxed font-medium">
                    ...
                    <div className="mb-16 md:mb-20" data-aos="fade-up">
                        <h3 className="text-2xl sm:text-3xl md:text-4xl font-bold text-[#012060] mb-6 md:mb-10 tracking-tight">
                            Key Features
                        </h3>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-6">
                            ...
                            <div className="space-y-4 sm:space-y-6">
                                <div className="flex items-start">
                                    <span className="text-gray-400 mr-2 sm:mr-3 mt-1.5 sm:mt-2 text-[10px] sm:text-xs">●</span>
                                    <p className="text-base sm:text-lg md:text-xl text-gray-800">State-of-the-Art Healthcare Facility</p>
                                </div>
                                <div className="flex items-start">
                                    <span className="text-gray-400 mr-2 sm:mr-3 mt-1.5 sm:mt-2 text-[10px] sm:text-xs">●</span>
                                ...
                                <div className="flex items-start">
                                    <span className="text-gray-400 mr-2 sm:mr-3 mt-1.5 sm:mt-2 text-[10px] sm:text-xs">●</span>
                                    <p className="text-base sm:text-lg md:text-xl text-gray-800">Regular Community Health Camps</p>
                                </div>
                                <div className="flex items-start">
                                    <span className="text-gray-400 mr-2 sm:mr-3 mt-1.5 sm:mt-2 text-[10px] sm:text-xs">●</span>
                                    <div>
                                        <p className="text-base sm:text-lg md:text-xl text-gray-800">Free and subsidized medical camps for:</p>
                                        <ul className="mt-2 ml-4 space-y-1 text-sm sm:text-base text-gray-600 list-none">
                                ...
                                <div className="flex items-start">
                                    <span className="text-gray-400 mr-2 sm:mr-3 mt-1.5 sm:mt-2 text-[10px] sm:text-xs">●</span>
                                    <div>
                                        <p className="text-base sm:text-lg md:text-xl text-gray-800">Health Meets Environment Initiative</p>
                                        <ul className="mt-2 ml-4 space-y-1 text-sm sm:text-base text-gray-600 list-none">
                            ...
                            <div className="space-y-4 sm:space-y-6">
                                <div className="flex items-start">
                                    <span className="text-gray-400 mr-2 sm:mr-3 mt-1.5 sm:mt-2 text-[10px] sm:text-xs">●</span>
                                    <div>
                                        <p className="text-base sm:text-lg md:text-xl text-gray-800">Affordable & Accessible Care</p>
                                        <ul className="mt-2 ml-4 space-y-1 text-sm sm:text-base text-gray-600 list-none">
                                ...
                                <div className="flex items-start">
                                    <span className="text-gray-400 mr-2 sm:mr-3 mt-1.5 sm:mt-2 text-[10px] sm:text-xs">●</span>
                                    <div>
                                        <p className="text-base sm:text-lg md:text-xl text-gray-800">Emergency & Outpatient Services (Planned)</p>
                                        <ul className="mt-2 ml-4 space-y-1 text-sm sm:text-base text-gray-600 list-none">
            ...
            <section className="relative w-full flex flex-col items-center">
                ...
                <div className="container mx-auto px-4 max-w-4xl text-center mb-8 md:mb-10" data-aos="fade-up">
                    <h4 className="text-2xl sm:text-3xl md:text-5xl font-bold text-[#012060] mb-3 md:mb-4">
                        Serving North Karachi at Its Core
                    </h4>
                    <p className="text-base sm:text-lg md:text-2xl font-medium text-gray-700">
                        ANCH will become a central healthcare hub for the community.
                    </p>
                </div>

                {/* Construction Image Container */}
                <div className="relative w-full h-[30vh] sm:h-[40vh] md:h-[50vh] lg:h-[70vh] overflow-hidden shadow-2xl" data-aos="zoom-in">
                    <img
