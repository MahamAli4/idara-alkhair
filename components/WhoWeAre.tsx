                    ...
                    >
                        <div className="max-w-full">
                            ...
                            <p 
                                data-aos="fade-up"
                                data-aos-delay="200"
                                className="text-base md:text-[1.1rem] lg:text-[1.25rem] leading-relaxed mb-5 opacity-90 font-medium"
                            >
                            ...
                            <div 
                                data-aos="zoom-in"
                                data-aos-delay="400"
                                className="grid grid-cols-1 sm:grid-cols-3 gap-4 lg:gap-6 mb-8 md:mb-5"
                            >

                                {/* Years Experience Card - Cyan */}
                                <div className="bg-idara-cyan aspect-auto sm:aspect-square flex flex-col items-center justify-center p-6 sm:p-4 rounded-[12px] text-center shadow-lg transition-all hover:-translate-y-2 hover:shadow-idara-cyan/30">
                                    <h3 className="text-4xl sm:text-2xl lg:text-4xl font-black ">38 +</h3>
                                    <p className="text-sm sm:text-[0.8rem] lg:text-[1.5rem] font-bold uppercase tracking-wide">
                                        Years
                                    </p>
                                ...
                                <div className="bg-idara-orange aspect-auto sm:aspect-square flex flex-col items-center justify-center p-6 sm:p-4 rounded-[12px] text-center shadow-lg transition-all hover:-translate-y-2 hover:shadow-idara-orange/30">
                                    <h3 className="text-4xl sm:text-2xl lg:text-4xl font-black">850 K</h3>
                                    <p className="text-sm sm:text-[0.8rem] lg:text-[1rem] font-bold uppercase tracking-wide">
                                        Individuals
                                    </p>
                                ...
                                <div className="bg-idara-yellow aspect-auto sm:aspect-square flex flex-col items-center justify-center p-6 sm:p-4 rounded-[12px] text-center shadow-lg transition-all hover:-translate-y-2 hover:shadow-idara-yellow/30">
                                    <h3 className="text-4xl sm:text-2xl lg:text-4xl font-black mb-1">6000</h3>
                                    <p className="text-sm sm:text-[0.8rem] lg:text-[1rem] font-bold uppercase tracking-wide">
                                        Students
                                    </p>
                                    <p className="text-xs sm:text-[0.6rem] lg:text-[0.7rem] text-black font-bold opacity-80 mt-1 uppercase leading-tight">
                            ...
                            >
                                ...
                                <p className="text-xs sm:text-[0.6rem] lg:text-[0.9rem] font-black opacity-70 uppercase tracking-widest sm:tracking-[0.15em] mt-2 relative z-10 text-black">
