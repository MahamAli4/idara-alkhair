            ...
            <div className="container mx-auto px-4 font-montserrat">
                <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
                    ...
                    >
                        ...
                        <div 
                            className="space-y-6 text-base md:text-lg text-gray-800 leading-relaxed max-w-2xl"
                            data-aos="fade-up"
                            data-aos-delay="150"
                        >
                    ...
                    >
                        <div className="relative">
                            ...
                            {/* Main Image */}
                            <div
                                className="relative z-10 w-[260px] md:w-[300px] h-[380px] md:h-[480px] overflow-hidden bg-gray-100 shadow-xl group"
                            ...
                            {/* Dark Blue Pill */}
                            <div 
                                className="absolute top-6 -right-20 w-10 md:w-14 h-40 md:h-48 bg-[#001f54] rounded-full z-0"
                                data-aos="fade-left"
                                data-aos-delay="300"
                            ></div>
                            ...
                            {/* Cyan Circle */}
                            <div 
                                className="absolute bottom-[38%] -right-20 w-14 md:w-16 h-14 md:h-16 bg-idara-cyan rounded-full z-20"
                                data-aos="zoom-in"
                                data-aos-delay="350"
                            ></div>
